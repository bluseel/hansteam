...
const Newmarket: React.FC = () => {
  ...
  const whyNewmarket = ['Historic Charm', 'Exceptional Amenities', 'Educational Excellence', 'Green Spaces', 'Strategic Location'];
  ...
  return (
    <div className='flex flex-row max-[600px]:flex-col pt-[70px] text-2xl overflow-hidden min-h-screen bg-primary-yellow font-normal overflow-x-hidden'>
      <div className="flex-2 p-6 mt-4">
        <h1 className="text-4xl font-bold mb-4 text-black">Experience the Vibrant Life of Newmarket, Ontario</h1>
        <p className="text-black font-normal">
          Situated in the heart of York Region, Newmarket is a dynamic town that combines modern amenities with historic charm. Known for its bustling downtown, excellent schools, and thriving arts scene, Newmarket is a perfect place for families, professionals, and retirees alike.
        </p>

        <h1 className="text-3xl font-bold my-4 text-black">Why Choose Newmarket?</h1>
        <ul className="flex gap-5 flex-wrap leading-none">
          {whyNewmarket.map((item, index) => (
